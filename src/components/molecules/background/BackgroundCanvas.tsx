...
const drawFrameCanvas = (canvas: fabric.Canvas, xSpace: number, topSpace: number, context: AppContextData) => {
...
export const BackgroundCanvas: React.FC = () => {
    ...
    useEffect(() => {
        ...
        drawFrameCanvas(frameCanvas, frameXSpace, frameTopSpace, context)
    }, [context.color])

    return (
        <div className="relative flex justify-center" style={{ width: frameW, height: frameH }}>
